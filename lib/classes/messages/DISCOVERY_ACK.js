...
var ADD_PROPERTIES = exports.ADD_PROPERTIES = [
  ...
  { name: 'device_mode', length: 4, type: 'int' },
  { name: 'reserved_1', length: 2, type: 'int' },
  { name: 'mac_address', length: 6, type: 'buffer' },

  { name: 'ip_config_options', length: 4, type: 'int' },
  { name: 'ip_config_current', length: 4, type: 'int' },

  { name: 'reserved_2', length: 4, type: 'int' },
  { name: 'reserved_3', length: 4, type: 'int' },
  { name: 'reserved_4', length: 4, type: 'int' },

  { name: 'current_ip_buf', length: 4, type: 'buffer' },


  { name: 'reserved_5', length: 4, type: 'int' },
  { name: 'reserved_6', length: 4, type: 'int' },
  { name: 'reserved_7', length: 4, type: 'int' },

  { name: 'current_subnet_mask_buf', length: 4, type: 'buffer' },

  { name: 'reserved_8', length: 4, type: 'int' },
  { name: 'reserved_9', length: 4, type: 'int' },
  { name: 'reserved_10', length: 4, type: 'int' },
