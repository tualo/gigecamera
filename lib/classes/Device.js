...
Device.prototype.readRegister = function(address,length,callback){
  var msg = new COMMANDS.READREG.READREG();
  msg.addRegister(address,length);
  me.gvcp.send(me._current_ip,msg,function(err,result){
