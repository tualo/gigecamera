...
var DATA_FORMAT = {};
DATA_FORMAT['DATA_LEADER'] = 1;
DATA_FORMAT['DATA_TRAILER'] = 2;
DATA_FORMAT['DATA_PAYLOAD'] = 3;

var DATA_FORMAT_NR = {};
DATA_FORMAT_NR[1] = 'DATA_LEADER';
DATA_FORMAT_NR[2] = 'DATA_TRAILER';
DATA_FORMAT_NR[3] = 'DATA_PAYLOAD';


var PAYLOAD_TYPE = {}
var PAYLOAD_TYPE_NR = {}
PAYLOAD_TYPE_NR[0x0001]='image';
PAYLOAD_TYPE_NR[0x0002]='raw data';
PAYLOAD_TYPE_NR[0x0003]='file';
PAYLOAD_TYPE_NR[0x0004]='chunk data';
PAYLOAD_TYPE_NR[0x0005]='extended chunk data';
PAYLOAD_TYPE_NR[0x8000]='device-specific';
PAYLOAD_TYPE['image'] = 0x0001;
PAYLOAD_TYPE['raw data'] = 0x0002;
PAYLOAD_TYPE['file'] = 0x0003;
PAYLOAD_TYPE['chunk data'] = 0x0004;
PAYLOAD_TYPE['extended chunk data'] = 0x0005;
PAYLOAD_TYPE['device-specific'] = 0x8000;
...
var regHash = {};
var regNames = Object.keys(REGISTER),
m=regNames.length;
for(i=0;i<m;i++){
  regHash[ REGISTER[regNames[i]].address ]=regNames[i];
}

exports.getRegisterString = function(num){
  if (typeof num==='number'){
    var x = Number(num).toString('16');
    while(x.length<4){
      x='0'+x;
    }
    num = '0x'+x;
  }
  if (typeof regHash[num]==='string'){
    return regHash[num];
  }else{
    return 'UNKOWN';
  }
...
exports.DATA_FORMAT_NR = DATA_FORMAT_NR;
exports.CONSTANTS = CONST;
exports.STATUS = STATUS;
exports.REGISTER = REGISTER;
exports.PAYLOAD_TYPE = PAYLOAD_TYPE;
exports.PAYLOAD_TYPE_NR = PAYLOAD_TYPE_NR;
